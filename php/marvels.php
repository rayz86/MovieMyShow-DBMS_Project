...
<html lang="en">
    ...
    <body>
        <h1 style="margin-left: 10px"><b>The Marvels</b></h1>
        <img src="https://cdn.marvel.com/content/1x/themarvels_lob_mas_mob_03.jpg" width="1300px" height="600">
        <br><br>
        ...
        <div style="margin-left: 15px">
            ...
            $q1="SELECT * FROM MOVIES WHERE M_id='103'";
