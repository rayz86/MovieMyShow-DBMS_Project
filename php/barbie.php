...
<html lang="en">
    ...
    <body>
        <h1 style="margin-left: 10px"><b>Barbie</b></h1>
        <img src="https://ntvb.tmsimg.com/assets/p13472534_v_h8_ae.jpg?w=960&h=540" width="1300px" height="600">
        <br><br>
        ...
        <div style="margin-left: 15px">
            ...
            $q1="SELECT * FROM MOVIES WHERE M_id='102'";
