...
<html lang="en">
    ...
    <body>
        <h1 style="margin-left: 10px"><b>Fast X</b></h1>
        <img src="https://www.thebanner.org/sites/default/files/styles/article_detail_header/public/2023-07/MM-1177%20Fast%20X.png?itok=rGkt2Ou7" width="1300px" height="600">
        <br><br>
        ...
        <div style="margin-left: 15px">
            ...
            $q1="SELECT * FROM MOVIES WHERE M_id='104'";
